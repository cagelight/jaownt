...
#define PRODUCT_NAME			"jaownt"

#define CLIENT_WINDOW_TITLE "Jedi Academy of Weird New Things"
#define CLIENT_CONSOLE_TITLE "Jedi Academy of Weird New Things"
#define HOMEPATH_NAME_UNIX "jaownt"
#define HOMEPATH_NAME_WIN "jaownt"
...
float	Q_frandrange(float min, float max);
