...
// Wookiee Bowcaster
XCVAR_DEF( weap_bowcasterAltBounceCount,		"20",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_bowcasterAltRange,				"0.3",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_bowcasterAltSpread,				"5.0",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_bowcasterBounceCount,			"0",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_bowcasterChargeUnit,			"200",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_bowcasterDamage,				"50",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_bowcasterHitboxSize,			"2",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_bowcasterSplashDamage,			"0",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_bowcasterSplashRadius,			"0",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_bowcasterVelocity,				"1300",		NULL,				CVAR_ARCHIVE,	qtrue )

// Bryar Pistol
XCVAR_DEF( weap_bryarPistolAltFireSize,			"1.0",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_bryarPistolBounceCount,			"8",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_bryarPistolChargeUnit,			"200.0",	NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_bryarPistolDamage,				"10",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_bryarPistolVelocity,			"1600",		NULL,				CVAR_ARCHIVE,	qtrue )

// Concussion Rifle
XCVAR_DEF( weap_concussionAltDamage,			"25",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_concussionAltPenetration,		"3",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_concussionBounceCount,			"0",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_concussionDamage,				"75",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_concussionSplashDamage,			"40",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_concussionSplashRadius,			"300",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_concussionVelocity,				"3000",		NULL,				CVAR_ARCHIVE,	qtrue )

// DEMP2
XCVAR_DEF( weap_demp2AltBounceCount,			"0",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_demp2AltDamage,					"8",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_demp2AltRadius,					"80000",	NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_demp2AltRange,					"4096",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_demp2AltSplashRadius,			"256",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_demp2BounceCount,				"0",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_demp2ChargeUnit,				"700.0",	NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_demp2Damage,					"35",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_demp2HitboxSize,				"2",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_demp2Velocity,					"1800",		NULL,				CVAR_ARCHIVE,	qtrue )

// Detonation Pack
XCVAR_DEF( weap_detpackAutoTimer,				"300",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_detpackDamage,					"100",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_detpackMaxCount,				"100",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_detpackSplashDamage,			"200",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_detpackSplashRadius,			"200",		NULL,				CVAR_ARCHIVE,	qtrue )

// Tenloss Disruptor
XCVAR_DEF( weap_disruptorAltDamage,				"100",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_disruptorAltPenetration,		"3",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_disruptorChargeUnit,			"50",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_disruptorMainDamage,			"30",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_disruptorMainDamage_Siege,		"50",		NULL,				CVAR_ARCHIVE,	qtrue )

// E11 Blaster
XCVAR_DEF( weap_e11AltSpread,					"1.6",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_e11BounceCount,					"0",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_e11Damage,						"20",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_e11Velocity,					"2300",		NULL,				CVAR_ARCHIVE,	qtrue )

// Golan Arms Flechette
XCVAR_DEF( weap_flechetteAltBounceCount,		"50",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_flechetteAltCount,				"2",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_flechetteAltDamage,				"60",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_flechetteAltHitboxSize,			"6",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_flechetteAltMaxVelocity,		"700",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_flechetteAltMinVelocity,		"700",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_flechetteAltMaxLife,			"7",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_flechetteAltMinLife,			"1.5",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_flechetteAltSplashDamage,		"60",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_flechetteAltSplashRadius,		"128",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_flechetteBounceCountMin,		"5",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_flechetteBounceCountMax,		"8",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_flechetteCount,					"5",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_flechetteDamage,				"15",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_flechetteHitboxSize,			"1",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_flechetteMineRadiusCheck,		"256",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_flechetteSpread,				"4.0",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_flechetteVelocity,				"3500",		NULL,				CVAR_ARCHIVE,	qtrue )

// Melee
XCVAR_DEF( weap_meleeSwing1Damage,				"10",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_meleeSwing2Damage,				"12",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_meleeRange				,		"8",		NULL,				CVAR_ARCHIVE,	qtrue )

// Heavy Repeater
XCVAR_DEF( weap_repeaterAltBounceCount,			"0",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_repeaterAltDamage,				"60",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_repeaterAltHitboxSize,			"3",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_repeaterAltSplashDamage,		"60",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_repeaterAltSplashRadius,		"128",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_repeaterAltSplashRadius_Siege,	"80",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_repeaterAltVelocity,			"1100",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_repeaterBounceCount,			"0",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_repeaterDamage,					"14",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_repeaterSpread,					"1.4",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_repeaterVelocity,				"1600",		NULL,				CVAR_ARCHIVE,	qtrue )

// Personal Rocket Launcher
XCVAR_DEF( weap_rocketAltThinkTime,				"0.1",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_rocketBounceCount,				"0",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_rocketDamage,					"100",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_rocketHitboxSize,				"3",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_rocketSplashDamage,				"100",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_rocketSplashRadius,				"160",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_rocketVelocity,					"900",		NULL,				CVAR_ARCHIVE,	qtrue )

// Stun Baton
XCVAR_DEF( weap_stunBatonAltDamage,				"20",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_stunBatonDamage,				"20",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_stunBatonRange,					"8",		NULL,				CVAR_ARCHIVE,	qtrue )

// Thermal Detonator
XCVAR_DEF( weap_thermalDetBounceCount,			"5",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_thermalDetDamage,				"70",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_thermalDetMinCharge,			"0.15",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_thermalDetSplashDamage,			"90",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_thermalDetSplashRadius,			"128",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_thermalDetTimer,				"3",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_thermalDetVelocity,				"900",		NULL,				CVAR_ARCHIVE,	qtrue )

// Trip Mine
XCVAR_DEF( weap_tripmineActivateDelay,			"1000",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_tripmineAutoTimer,				"300",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_tripmineDamage,					"100",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_tripmineDelayTime,				"0.05",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_tripmineHitboxSize,				"1.5",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_tripmineMaxCount,				"100",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_tripmineSplashRadius,			"256.0",	NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_tripmineSplashDamage,			"105",		NULL,				CVAR_ARCHIVE,	qtrue )
XCVAR_DEF( weap_tripmineVelocity,				"900.0",	NULL,				CVAR_ARCHIVE,	qtrue )
