...
XCVAR_DEF( weap_flechetteAltVelocitySpread,		"0.07",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_flechetteAltVelocity,			"750",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_flechetteAltLifeSpread,			"6",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_flechetteAltLife,				"1.5",		NULL,				CVAR_NONE,	qtrue )
...
XCVAR_DEF( weap_flechetteLife,					"4.5",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_flechetteLifeSpread,			"0.5",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_flechetteMineRadiusCheck,		"256",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_flechetteSpread,				"4.0",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_flechetteVelocity,				"3250",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_flechetteVelocitySpread,		"0.07",		NULL,				CVAR_NONE,	qtrue )
...
// Rocket Launcher
XCVAR_DEF( weap_rocketAltBounceCount,			"0",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_rocketAltBouncy,				"0",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_rocketAltDamage,				"100",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_rocketAltHitboxSize,			"3",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_rocketAltProjectileLife,		"10",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_rocketAltSplashDamage,			"100",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_rocketAltSplashRadius,			"160",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_rocketAltThinkTime,				"0.1",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_rocketAltVelocity,				"450",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_rocketBounceCount,				"0",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_rocketBouncy,					"0",		NULL,				CVAR_NONE,	qtrue )
...
//Turbolaser
XCVAR_DEF( weap_turbolaserCooldownMin,			"1",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_turbolaserCooldownMax,			"1",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_turbolaserDamage,				"500",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_turbolaserHealth,				"2000",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_turbolaserProjectileLife,		"10",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_turbolaserSearchRadius,			"32768",	NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_turbolaserSpeed,				"20000",	NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_turbolaserSplashDamage,			"200",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_turbolaserSplashRadius,			"500",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_turbolaserSpread,				"2.0",		NULL,				CVAR_NONE,	qtrue )

//Turret
XCVAR_DEF( weap_turretCooldownMax,				"0.0205",	NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_turretCooldownMin,				"0.0150",	NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_turretDamage,					"500",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_turretHealth,					"100",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_turretProjectileLife,			"10",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_turretSearchRadius,				"512",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_turretSpeed,					"1100",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_turretSplashDamage,				"10",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_turretSplashRadius,				"25",		NULL,				CVAR_NONE,	qtrue )
XCVAR_DEF( weap_turretSpread,					"2.0",		NULL,				CVAR_NONE,	qtrue )
